...
array1W = quick_draw_data_set[random_number];

document.getElementById("Sketch").innerHTML = "Your Sketch: "+array1W;
...
function updateCanvas() {
   ...
   answer_holder = "set"
   points_scored++;
   document.getElementById('score').innerHTML = 'Score: ' + points_scored;
         }
...
function preload(){
   ...
   function gotResults(error, results){
      ...
      if(error){
        ...
        utterthis = new SpeechSynthesisUtterance(results[0].label); //[0] is a array which stores the name of the object.//
